...
const renderActiveShape = props => {
  ...
  return (
    <g>
      ...
      <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} textAnchor={textAnchor} fill="#E86363">{`PV ${value}`}</text>
      ...
      <section id="skills">
        <div className="skills__front-end">
          ...
          <PieChart width={400} height={400}>
            <Pie activeIndex={this.state.activeIndex} activeShape={renderActiveShape} data={data} cx={200} cy={200} innerRadius={60} outerRadius={80} fill="#E86363" dataKey="value" onMouseEnter={this.onPieEnter} />
          </PieChart>
        </div>
